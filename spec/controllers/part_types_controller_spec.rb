  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved part_type as @part_type" do
        ...
        post :create, {:part_type => { "name" => "invalid value" }}, valid_session
        assigns(:part_type).should be_a_new(PartType)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested part_type" do
        ...
        PartType.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => part_type.to_param, :part_type => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the part_type as @part_type" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        PartType.any_instance.stub(:save).and_return(false)
        put :update, {:id => part_type.to_param, :part_type => { "name" => "invalid value" }}, valid_session
        assigns(:part_type).should eq(part_type)
      end
